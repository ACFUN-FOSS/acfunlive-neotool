...
function loadAppsConfig(appsDir) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield d('plugin:acfunlive-neotool-base|load_apps_config', { appsDir });
    });
}
function canonicalize(path) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield d('plugin:acfunlive-neotool-base|canonicalize', { path });
    });
}
function hashFileSha256(path) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield d('plugin:acfunlive-neotool-base|hash_file_sha256', { path });
    });
}
function symlinkDir(source, destination) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield d('plugin:acfunlive-neotool-base|symlink_dir', { source, destination });
    });
}
