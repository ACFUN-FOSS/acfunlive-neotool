...
function isAddressAvailable(hostname, port) {
    checkPort(port);
    d('plugin:acfunlive-neotool-serve-files|is_address_available', { hostname, port });
}
class Server {
    constructor(id) {
    ...
    static startServe(dir, hostname, port) {
        return __awaiter(this, void 0, void 0, function* () {
            checkPort(port);
            const id = yield d('plugin:acfunlive-neotool-serve-files|start_serve', {
                dir,
                hostname,
                port
            });
    ...
    stopServe() {
        return __awaiter(this, void 0, void 0, function* () {
            yield d('plugin:acfunlive-neotool-serve-files|stop_serve', { id: __classPrivateFieldGet(this, _Server_id, "f") });
        });
    }
    isServing() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield d('plugin:acfunlive-neotool-serve-files|is_serving', { id: __classPrivateFieldGet(this, _Server_id, "f") });
        });
    }
}
