...
class KeyboardListener {
    ...
    static start_listen(keyDown, keyUp) {
        return __awaiter(this, void 0, void 0, function* () {
            const id = yield d('plugin:acfunlive-neotool-keyboard|start_listen', {
                keyDownCallback: s(keyDown),
                keyUpCallback: s(keyUp)
            });
    ...
    stop_listen() {
        return __awaiter(this, void 0, void 0, function* () {
            yield d('plugin:acfunlive-neotool-keyboard|stop_listen', { id: __classPrivateFieldGet(this, _KeyboardListener_id, "f") });
        });
    }
}
...
function simulate_input(input) {
    return __awaiter(this, void 0, void 0, function* () {
        yield d('plugin:acfunlive-neotool-keyboard|simulate_input', { input });
    });
}
